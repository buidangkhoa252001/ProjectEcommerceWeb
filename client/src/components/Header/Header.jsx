...
const Header = () => {
  ...
  const adminRouter = () =>{
    ...
    return (
        ...
        {
            isAuth ? loggedRouter() : <li><Link to="/login" style={{textDecoration: "none", padding: "10px"}}>Login </Link> <Link to="/register" style={{textDecoration: "none", padding: "10px", border: "1px solid #bfbfbf", borderRadius: "30px",}}> Register</Link>  
