...
function Cart() {
    ...
    if (user.cart.length === 0)
        return (<div className="box_cart-empty">
            <ion-icon name="close-circle-outline"></ion-icon>
            <h2 style={{ textAlign: "center", fontSize: "7rem" }}>Cart Empty</h2>
        </div>
        )
    return (
                ...
                <div className="cart-container_total-price">
                    ...
                    <div className="cart-container_total-price-detail">
                        ...
                        <div className="cart-container_total-price-detail-button">
                            <Link style={{ textDecoration: "none", color: "white", width: "350px" }} to="/checkout"><button>Continue<ion-icon name="arrow-forward-circle-outline"></ion-icon></button></Link>
                        </div>
                    </div>
                </div>
            </div>
